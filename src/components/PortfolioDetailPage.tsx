...
export default function PortfolioDetailPage({
  ...
  const galleryThumbnails = [
    project.imageUrl,
    "/images/zeke_project_one_1781624725520.jpg",
    "/images/zeke_project_two_1781624742258.jpg",
    "/images/zeke_project_three_1781624759261.jpg",
    "/images/zeke_about_workflow_1781626977867.jpg",
  ...
  while (galleryThumbnails.length < 4) {
    galleryThumbnails.push("/images/zeke_hero_1781624709150.jpg");
  }
